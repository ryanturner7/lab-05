...
// var sum = 4+7;
// function sum(question, correctAnswer){
// var concat = prompt(question);
// if(typeof concat === 'string'){
//   concat = concat.toLowerCase().trim();
// }
//   if(concat.toLowerCase() === 'correctValue' || concat === 'correctValue'[0]){
...
function multiplyArray(array){
  ...
  var msg = '';
  for (var i=0; i < array.length; i++){
    currentProduct = multiply(array[i], currentProduct)[0];
  }
  var returnValue = [currentProduct,'The numbers ' +  array.join(',') +  ' have a product of ' + currentProduct + '.' ];
console.log(returnValue);
  return returnValue;
}
